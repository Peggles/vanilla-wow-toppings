...
local function GetFormattedTime(time)
	--day
	if (time >= 86400) then
		return ( math.floor((time / 86400 + 0.5)) .. "d" ), 0.6, OmniCC.long.r, OmniCC.long.g, OmniCC.long.b, math.mod(time, 86400);
	--hour
	elseif (time >= 3600) then
		return ( math.floor((time / 3600 + 0.5)) .. "h" ), 0.6, OmniCC.long.r, OmniCC.long.g, OmniCC.long.b, math.mod(time, 3600);
	--minute
	elseif (time >= 60) then
		return ( math.floor((time / 60 + 0.5)) .. "m" ), 0.8, OmniCC.long.r, OmniCC.long.g, OmniCC.long.b, math.mod(time, 60);
